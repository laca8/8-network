...
import { addLike, deleteLike, deletePost, getPosts } from '../../redux/actions/postAction'
...
export const Post = ({post}) => {
    ...
    return (
        <>
         {error && <h6>{error}</h6>}
        <div  className='card my3 container'>
        ...
        <div className="d-flex">
            ...
            <div class="dropdown">
                  ...
                  </button>
                  {
                        ...
                        <li><button className="dropdown-item" type="button" onClick={handleEditPost}><i className="fas fa-edit"></i></button></li>
                        <li><button className="dropdown-item" type="button" onClick={handleDeletePost}><i className="fas fa-trash-alt"></i></button></li>
                         <li><button className="dropdown-item" type="button" onClick={handleCopyLink}><i className="fas fa-copy"></i></button></li>
                    </ul>
                    :  <ul className="dropdown-menu" aria-labelledby="dropdownMenu2">
                     <li><button className="dropdown-item" type="button" onClick={handleCopyLink}><i className="fas fa-copy"></i></button></li>
                </ul>
        ...
        <div className="card_body">
         ...
         <div className='card_icon_menu' style={{display:'flex'}}>
           ...
           <span style={{display:'flex'}}>
             ...
             <LikeButton handleDeleteLike={handleDeleteLike} handleLike={handleLike} displayLike={displayLike}/>
            
    
           {
                     displayComment ?  <i className='fas fa-comment' onClick={handleDisplayComment}/>  : 
